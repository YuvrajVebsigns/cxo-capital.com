...
// export default function CIOcrownPage() {
//   return (
//     <main>
//       <h1>CXO Hub</h1>
//     </main>
  ...
  return (
    <main>
      <section className="hero-section">
        <Image
          src="/assets/hero/hero-crown.png"
          alt="CIO Powerlist"
          width={1400}
          height={800}
          priority
        ...
        <div className="aboutsection1-container">
          <div className="aboutsection1-heading">
            ...
            <h2 className="aboutsection1-title">
              ABOUT <span>CIO CROWN</span>
            </h2>

            <p className="aboutsection1-description">
              CIO Crown is a powerful recognition platform for ICT brands to promote their products,
      ...
      <section className="website-cta-section">
        <div className="website-cta-container">
          ...
          <h2>
            Want to Explore the Complete <br /> <span>CIO-Crown</span> Experience?
          </h2>

          <p>
            Visit the official CIO Crown website to discover award categories, sucessfull year,
            events, partners, videos and much more.
          </p>
